...
class DealsPage extends StatefulWidget {
  ...
  DealsPage({Key key, this.toolbarname}) : super(key: key);
  @override
  State<StatefulWidget> createState() => _Deals(toolbarname);
}
...
class _Deals extends State<DealsPage> {
  List list = ['17', '11'];
