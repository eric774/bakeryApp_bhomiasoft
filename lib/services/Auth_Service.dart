...
class AuthClass {
  ...
  void storeTokenAndData(UserCredential userCredential) async {
    ...
    await storage.write(
        key: "isLogged", value: isLoggedInSuccessfully.toString());
  }

  Future<String> getToken() async {
    isLoggedInSuccessfully = toBoolean(storage.read(key: "isLogged"));
  ...
  Future<void> signInwithPhoneNumber(
    ...
    try {
      ...
      Navigator.pushAndRemoveUntil(context,
          MaterialPageRoute(builder: (builder) => BodyOTP()), (route) => false);
